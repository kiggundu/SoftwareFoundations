...
(* rewrite attempts to use a hypothesis to rephrase your current goal whereas apply brings the hypothesis down as your current goal provided the current goal can be substituted into it.
