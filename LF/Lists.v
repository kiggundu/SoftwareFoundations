...
Proof.
  ...
  induction l.
  - simpl. reflexivity.
  - simpl. rewrite <- IHl. simpl. rewrite <- eqb_refl. reflexivity.
Qed.
(** [] *)
...
(* FILL IN HERE *)
Theorem rev_injective: forall (l1 l2 : natlist), l1 = l2 -> rev l1 = rev l2.
Proof.
...
(* It has 2 elements as defined by the 2 constructors. *)
